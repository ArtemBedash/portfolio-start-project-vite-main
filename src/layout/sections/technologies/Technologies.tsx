...
export const Technologies = () => {
    ...
    return (
        ...
        <StyledTechnologies id={"technologies"}>
            ...
            <FlexWrapper justify={"center"} mobileWrap={'wrap'} gap="50px" mobileGap={"30px"}>
                <Icon iconId={"html"} width={"100px"} height={"100px"} viewBox={"0 0 95 105"}/>
                <Icon iconId={"css"} width={"100px"} height={"100px"} viewBox={"0 0 95 105"}/>

                <Icon iconId={"js"} width={"100px"} height={"100px"} viewBox={"0 0 100 100"}/>
                <Icon iconId={"react"} width={"100px"} height={"100px"} viewBox={"0 0 115 100"}/>
                <Icon iconId={"gittech"} width={"100px"} height={"100px"} viewBox={"0 0 90 85"}/>
